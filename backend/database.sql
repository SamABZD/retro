    ...
    CREATE TABLE Product (
        ...
        itemCondition ENUM('NEW', 'LIKE_NEW', 'GOOD', 'FAIR', 'POOR') DEFAULT 'GOOD',
        listingStatus ENUM('ACTIVE', 'SOLD', 'INACTIVE', 'ARCHIVED') DEFAULT 'ACTIVE',
        createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
        updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    -- Additive image gallery. Product.imageUrl remains the compatible primary image.
