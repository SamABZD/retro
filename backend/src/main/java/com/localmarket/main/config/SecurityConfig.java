    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Public pages and Vite-built assets for the same-origin portfolio demo.
                .requestMatchers(HttpMethod.GET,
                    "/", "/index.html", "/assets/**", "/demo/**", "/favicon.svg", "/favicon.png",
                    "/login", "/register", "/forgot-password", "/search", "/item-details/*",
                    "/cart", "/order-success", "/terms", "/privacy", "/fraud-prevention",
                    "/faq", "/about", "/contact", "/create-seller-profile",
                    "/user/dashboard", "/user/dashboard/**", "/seller/dashboard", "/seller/dashboard/**")
                    .permitAll()
                // WebSocket endpoint
                ...
                .requestMatchers(HttpMethod.POST,
                    ...
                    "/api/auth/register",
                    "/api/auth/password-reset-request",
                    "/api/auth/password-reset-verify").permitAll()
                ...
                // Canonical marketplace listing routes (legacy /api/products remains supported)
                .requestMatchers(HttpMethod.GET, "/api/listings/my-products").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.GET, "/api/listings/my-listings/**").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.GET, "/api/listings/my-pending").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.GET, "/api/listings/pending").hasAuthority(ADMIN)
                ...
                .requestMatchers(HttpMethod.POST, "/api/listings").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.PUT, "/api/listings/**").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.DELETE, "/api/listings/admin/**").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.DELETE, "/api/listings/**").hasAuthority(PRODUCER)
                .requestMatchers(HttpMethod.POST, "/api/listings/{id}/approve").hasAuthority(ADMIN)
                .requestMatchers(HttpMethod.POST, "/api/listings/{id}/decline").hasAuthority(ADMIN)
            ...
            .exceptionHandling(errors -> errors
                .authenticationEntryPoint((request, response, exception) -> {
                    ...
                    response.getWriter().write(
                        "{\"code\":\"INVALID_SESSION\",\"message\":\"Authentication required\"}");
                })
